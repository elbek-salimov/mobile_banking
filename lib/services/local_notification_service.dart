...
import 'package:mobile_banking/screens/tab/home/home_screen.dart';
import 'dart:async';
...
class LocalNotificationService {
  ...
  static int getUniqueNotificationId() {
    return DateTime.now().millisecondsSinceEpoch + notificationId++;
  }
  ...
  void showNotification({
    ...
    LocalNotificationService.getUniqueNotificationId();
    ...
    debugPrint("CURRENT NOTIFICATION ID:$notificationId");
  }
